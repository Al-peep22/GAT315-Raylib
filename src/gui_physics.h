/*******************************************************************************************
*
*   Physics v1.0.0 - UI-Physics-Project
*
*   MODULE USAGE:
...
*
*   Copyright (c) 2022 alison. All Rights Reserved.
*
...
void GuiPhysics(GuiPhysicsState *state)
{
    ...
    if (state->WorldBoxActive)
    {
        ...
        GuiSlider((Rectangle){ state->anchor01.x + 72, state->anchor01.y + 64, 184, 16 }, "GRAVITY", GUI_TEXT(state->GravityValue), & state->GravityValue, 0, 100);
        GuiSliderBar((Rectangle){ state->anchor01.x + 72, state->anchor01.y + 40, 184, 16 }, "FPS", GUI_TEXT(state->FPSValue), & state->FPSValue, 0, 100);
